...
function switchDark() {
    ...
    if (darkMode) {
        ...
        document.querySelectorAll('.videoHelperBtn').forEach(button => {
            ...
            button.classList.remove('bg-pink-300', 'text-white', 'text-2xl', 'rounded-full','border-pink-500','border-4','mb-4'); // Removing light mode classes
        });
    } else {
        ...
        document.querySelectorAll('.videoHelperBtn').forEach(button => {
            ...
            button.classList.add('bg-pink-300', 'text-white', 'text-5xl', 'rounded-full','border-pink-500','border-4','mb-4'); // Example classes for light mode
        });
    }
